...
const useFurnitureMannequinWidgetState = () => {
  ...
  useRoomEngineEvent<RoomEngineTriggerWidgetEvent>(RoomEngineTriggerWidgetEvent.REQUEST_MANNEQUIN, event => {
    ...
    const figure = (model.getValue(RoomObjectVariable.FURNITURE_MANNEQUIN_FIGURE) || null)
    const gender = (model.getValue(RoomObjectVariable.FURNITURE_MANNEQUIN_GENDER) || null)
    ...
    setName(model.getValue(RoomObjectVariable.FURNITURE_MANNEQUIN_NAME) || null)
  })
