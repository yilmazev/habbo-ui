...
export class AvatarEditorUtilities {
  ...
  public static createCategory(model: CategoryBaseModel, name: string): CategoryData {
    ...
    // if(this._forceSellableClothingVisibility || GetNitroInstance().getConfiguration("avatareditor.support.sellablefurni", false))
    // {
  ...
  public static get clubItemsFirst(): boolean {
    return GetConfiguration("avatareditor.show.clubitems.first", true)
  }

  public static get clubItemsDimmed(): boolean {
    return GetConfiguration("avatareditor.show.clubitems.dimmed", true)
  }
}
