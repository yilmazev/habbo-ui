        ...
        <div className="relative flex w-full items-end justify-between">
          <div>
            ...
            <div className="flex items-center">
              <LayoutAvatarImage className="!h-[115px] !w-[49px] !bg-[-25px_-10px]" figure={userProfile.figure} direction={2} />
            ...
            <div className="flex justify-end gap-1">
              <div className="illumina-btn-group flex">
                {getFriend(userProfile.id) && <>
                  <button className="illumina-btn-primary flex h-7 items-center justify-center pl-2" onClick={event => processAction("message")}>
                    <i className="block size-3.5 cursor-pointer bg-[url('/client-assets/images/spritesheet.png?v=2451779')] bg-[-180px_-98px]" />
                  </button>
                  ...
                  <button className="illumina-btn-primary flex h-7 items-center justify-center pr-2" disabled>
                    <i className={`block h-4 w-[15px] cursor-pointer bg-[url('/client-assets/images/spritesheet.png?v=2451779')] ${userProfile.isOnline ? "bg-[-197px_-83px]" : "bg-[-229px_-83px]"}`} />
                  </button>
                </>}
              </div>
              {!getFriend(userProfile.id) &&
              ...
              {canRequestFriend(userProfile.id) &&
                <Button className="!size-7 !px-0" onClick={event => processAction("friend")}>
                  <i className="block size-4 cursor-pointer bg-[url('/client-assets/images/spritesheet.png?v=2451779')] bg-[-197px_-100px]" />
                </Button>}
              {!(userProfile.id === GetSessionDataManager().userId) &&
                <Button className="!size-7 !px-0" onClick={event => processAction("report")}>
                  <i className="block h-4 w-[15px] cursor-pointer bg-[url('/client-assets/images/spritesheet.png?v=2451779')] bg-[-213px_-83px]" />
                </Button>}
            </div>
          </div>
