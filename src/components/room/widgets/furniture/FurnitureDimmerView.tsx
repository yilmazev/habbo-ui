...
import { Button, DraggableWindowPosition, IlluminaCard, IlluminaCardContent, IlluminaCardHeader, NitroCardTabsItemView, NitroCardTabsView } from "../../../../common"
...
export const FurnitureDimmerView: FC<{}> = props => {
  ...
  return (
    <IlluminaCard uniqueKey="dimmer" className="illumina-dimmer w-[260px]" windowPosition={DraggableWindowPosition.TOP_LEFT}>
      <IlluminaCardHeader headerText={LocalizeText("widget.dimmer.title")} onCloseClick={onClose} />
      {(dimmerState === 1) &&
        <NitroCardTabsView>
