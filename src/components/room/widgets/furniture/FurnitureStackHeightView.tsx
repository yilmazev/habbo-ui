...
export const FurnitureStackHeightView: FC<{}> = props => {
  ...
  return (
    <IlluminaCard uniqueKey="furniture-stack-height" className="illumina-furniture-stack-height w-80">
      <IlluminaCardHeader headerText={LocalizeText("widget.custom.stack.height.title")} onCloseClick={onClose} />
      <IlluminaCardContent>
