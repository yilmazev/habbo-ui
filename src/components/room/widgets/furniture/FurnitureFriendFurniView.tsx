      ...
      <IlluminaCard uniqueKey="engraving-confirm" className="illumina-engraving-confirm w-[300px]">
        ...
        <IlluminaCardContent>
          ...
          <div className="mb-2 flex justify-center">
            <i className="h-[39px] w-[31px] bg-[url('/client-assets/images/spritesheet.png?v=2451779')] bg-[-278px_-212px]" />
          </div>
      ...
      <DraggableWindow uniqueKey="engraving" handleSelector=".illumina-engraving">
        <div className="illumina-engraving relative w-[373px] bg-[url('/client-assets/images/room-widgets/friend-furni/spritesheet.png?v=2451779')]" style={getLockView()}>
          ...
          <div className="flex h-[108px] justify-center">
            <LayoutAvatarImage className="!h-full !bg-[6px_-25px]" figure={figures[0]} direction={2} />
            <LayoutAvatarImage className="!h-full !bg-[-14px_-25px]" figure={figures[1]} direction={4} />
          </div>
      ...
      <DraggableWindow uniqueKey="engraving" handleSelector=".illumina-engraving">
        <div className="illumina-engraving relative w-[373px] bg-[url('/client-assets/images/room-widgets/friend-furni/spritesheet.png?v=2451779')]" style={getLockView()}>
          ...
          <div className="flex h-[121px] justify-center">
            <LayoutAvatarImage className="!h-full !bg-[6px_-12px]" figure={figures[0]} direction={2} />
            <LayoutAvatarImage className="!h-full !bg-[-14px_-12px]" figure={figures[1]} direction={4} />
          </div>
