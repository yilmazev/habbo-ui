...
export const MonsterPlantSeedConfirmView: FC<MonsterPlantSeedConfirmViewProps> = props => {
  ...
  return (
    <IlluminaCard uniqueKey="monsterplant-seed-confirm" className="illumina-monsterplant-seed-confirm w-[350px]">
      <IlluminaCardHeader headerText={LocalizeText("useproduct.widget.title.plant_seed", ["name"], [furniData.name])} onCloseClick={onClose} />
