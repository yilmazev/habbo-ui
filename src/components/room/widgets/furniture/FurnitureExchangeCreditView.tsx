...
export const FurnitureExchangeCreditView: FC<{}> = props => {
  ...
  return (
    <IlluminaCard uniqueKey="furniture-exchange" className="illumina-furniture-exchange h-[145px] w-[375px]" windowPosition={DraggableWindowPosition.TOP_LEFT}>
      <IlluminaCardHeader headerText={LocalizeText("catalog.redeem.dialog.title")} onCloseClick={onClose} />
      <IlluminaCardContent>
