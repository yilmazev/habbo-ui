...
export const FurnitureBackgroundColorView: FC<{}> = props => {
  ...
  return (
    <IlluminaCard uniqueKey="furniture-background-color" className="illumina-furniture-background-color w-[250px]">
      <IlluminaCardHeader headerText={LocalizeText("widget.backgroundcolour.title")} onCloseClick={onClose} />
      <IlluminaCardContent>
