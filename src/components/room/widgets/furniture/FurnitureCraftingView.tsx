...
import { Button, IlluminaBigCard, IlluminaBigCardContent, IlluminaBigCardHeader, LayoutGridItem } from "../../../../common"
...
export const FurnitureCraftingView: FC<{}> = props => {
  ...
  return (
    <IlluminaBigCard uniqueKey="crafting" className="illumina-crafting w-[541px]">
      <IlluminaBigCardHeader headerText={LocalizeText("crafting.title")} />
