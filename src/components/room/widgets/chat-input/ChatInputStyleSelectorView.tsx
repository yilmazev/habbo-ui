...
export const ChatInputStyleSelectorView: FC<ChatInputStyleSelectorViewProps> = props => {
  ...
  return (
    <>
      <i className="absolute right-2 block h-[19px] w-[17px] cursor-pointer bg-[url('/client-assets/images/spritesheet.png?v=2451779')] bg-[-353px_0px]" onClick={toggleSelector} />
      {selectorVisible &&
