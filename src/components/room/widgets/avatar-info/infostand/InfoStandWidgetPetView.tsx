                ...
                <div className="flex flex-col gap-1">
                  <div className="flex flex-col items-center">
                    ...
                    <div className="relative h-4 w-40 border border-[#CCCCCC]">
                      ...
                      <i className="absolute -left-2.5 -top-0.5 size-[18px] bg-[url('/client-assets/images/spritesheet.png?v=2451779')] bg-[-305px_-84px]" />
                    </div>
                  </div>
                ...
                <div className="flex flex-col gap-1">
                  <div className="flex flex-col items-center">
                    ...
                    <div className="relative h-4 w-40 border border-[#CCCCCC]">
                      ...
                      <i className="absolute -left-2.5 -top-0.5 size-[18px] bg-[url('/client-assets/images/spritesheet.png?v=2451779')] bg-[-324px_-84px]" />
                    </div>
                  </div>
                  <div className="flex flex-col items-center">
                    ...
                    <div className="relative h-4 w-40 border border-[#CCCCCC]">
                      ...
                      <i className="absolute -left-2.5 -top-0.5 size-[18px] bg-[url('/client-assets/images/spritesheet.png?v=2451779')] bg-[-343px_-84px]" />
                    </div>
                  </div>
                  <div className="flex flex-col items-center">
                    ...
                    <div className="relative h-4 w-40 border border-[#CCCCCC]">
                      ...
                      <i className="absolute -left-2.5 -top-0.5 size-[18px] bg-[url('/client-assets/images/spritesheet.png?v=2451779')] bg-[-362px_-84px]" />
                    </div>
                  </div>
                </div>
              </div>
