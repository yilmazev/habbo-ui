...
import { Button, DraggableWindowPosition, IlluminaCard, IlluminaCardContent, IlluminaCardHeader, LayoutPetImageView } from "../../../../common"
...
export const AvatarInfoPetTrainingPanelView: FC<{}> = props => {
  ...
  return (
    <IlluminaCard uniqueKey="pet-training" className="illumina-pet-training w-[195px]" windowPosition={DraggableWindowPosition.TOP_LEFT}>
      <IlluminaCardHeader headerText={LocalizeText("widgets.pet.commands.title")} onCloseClick={() => setPetTrainInformation(null)} />
      <IlluminaCardContent>
