...
import { Base, Button, Column, Flex, Grid, IlluminaCard, IlluminaCardContent, IlluminaCardHeader, Text } from "../../common";
...
export const CalendarView: FC<CalendarViewProps> = props => {
  ...
  return (
    <IlluminaCard uniqueKey="campaign-calendar" className="nitro-campaign-calendar">
      <IlluminaCardHeader headerText={LocalizeText(`campaign.calendar.${campaignName}.title`)} onCloseClick={onClose} />
      <IlluminaCardContent>
