...
export const AchievementsView: FC<{}> = props => {
  ...
  return (
    <IlluminaCard uniqueKey="achievements" className="illumina-achievements h-[420px] min-h-[430px] w-[392px]">
      <IlluminaCardHeader headerText={LocalizeText("inventory.achievements")} onCloseClick={event => setIsVisible(false)} />
      <IlluminaCardContent className="h-full !overflow-auto">
        {selectedCategory && <>
