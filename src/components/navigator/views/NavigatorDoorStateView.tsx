...
export const NavigatorDoorStateView: FC<{}> = props => {
  ...
  return (
    <IlluminaCard uniqueKey="door-state" className="illumina-door-state w-[237px]" windowPosition={DraggableWindowPosition.TOP_LEFT}>
      <IlluminaCardHeader headerText={LocalizeText(isDoorbell ? "navigator.doorbell.title" : "navigator.password.title")} onCloseClick={onClose} />
      <IlluminaCardContent>
