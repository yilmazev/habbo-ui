...
export const ModToolsUserSendMessageView: FC<ModToolsUserSendMessageViewProps> = props => {
  ...
  return (
    <IlluminaCard uniqueKey="mod-tools-user-message" className="illumina-mod-tools-user-message" windowPosition={DraggableWindowPosition.TOP_LEFT}>
      <IlluminaCardHeader headerText={`Message to: ${user.username}`} onCloseClick={() => onCloseClick()} />
      <IlluminaCardContent>
