...
export const ModToolsUserRoomVisitsView: FC<ModToolsUserRoomVisitsViewProps> = props => {
  ...
  return (
    <IlluminaCard uniqueKey="mod-tools-user-visits" className="illumina-mod-tools-user-visits" windowPosition={DraggableWindowPosition.TOP_LEFT}>
      <IlluminaCardHeader headerText={`Room Visits: ${userName}`} onCloseClick={onCloseClick} />
      <IlluminaCardContent>
