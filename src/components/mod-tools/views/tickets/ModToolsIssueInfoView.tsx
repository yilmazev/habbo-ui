...
export const ModToolsIssueInfoView: FC<IssueInfoViewProps> = props => {
  ...
  return (
    <>
      <IlluminaCard uniqueKey="mod-tools-handle-issue" className="illumina-mod-tools-handle-issue">
        <IlluminaCardHeader headerText="Issue handling" onCloseClick={() => onIssueInfoClosed(issueId)} />
        <IlluminaCardContent>
