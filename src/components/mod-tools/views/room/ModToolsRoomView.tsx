...
export const ModToolsRoomView: FC<ModToolsRoomViewProps> = props => {
  ...
  return (
    <IlluminaCard uniqueKey="mod-tools-room" className="illumina-mod-tools-room" windowPosition={DraggableWindowPosition.TOP_LEFT}>
      <IlluminaCardHeader headerText="Room Info" onCloseClick={event => onCloseClick()} />
      <IlluminaCardContent>
