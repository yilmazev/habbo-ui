...
export const AvatarEditorView: FC<{}> = props => {
  ...
  const showRandomFigure = GetConfiguration("illumina.random.figure.enabled")
  ...
  return (
    <IlluminaCard uniqueKey="avatar-editor" className="illumina-avatar-editor relative max-h-[465px] min-h-[465px] w-[510px]">
      <IlluminaCardHeader headerText={!genderFootballGate ? LocalizeText("avatareditor.title") : LocalizeText("widget.furni.clothingchange.editor.title")} onCloseClick={onClose} />
      <IlluminaCardContent className="flex flex-1 flex-col justify-center">
