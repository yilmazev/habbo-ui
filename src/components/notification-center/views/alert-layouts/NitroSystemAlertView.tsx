...
{
  const { title = "Nitro with Flash UI", onClose = null, ...rest } = props
  ...
  return (
    <LayoutNotificationAlertView title={ title } onClose={ onClose } { ...rest }>
      <div className="flex gap-3">
        ...
        <div className="pr-3">
          <p className="mb-1.5 text-center font-semibold [text-shadow:_0_1px_0_#fff] dark:[text-shadow:_0_1px_0_#33312B]">Nitro React with Flash UI</p>
          ...
          <p className="text-sm"><b className="font-semibold [text-shadow:_0_1px_0_#fff] dark:[text-shadow:_0_1px_0_#33312B]">Flash UI:</b> v{ GetIlluminaVersion() }</p>
