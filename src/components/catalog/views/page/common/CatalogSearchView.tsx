  ...
  return (
    <div className="illumina-input relative h-[26px] w-full">
      ...
      {searchValue?.length > 1
        ? <i className="absolute right-1.5 top-1.5 size-[11px] cursor-pointer bg-[url('/client-assets/images/spritesheet.png?v=2451779')] bg-[-63px_-207px] bg-no-repeat" onClick={event => setSearchValue("")} />
        : <i className="absolute right-[3px] top-[3px] h-[18px] w-[17px] bg-[url('/client-assets/images/spritesheet.png?v=2451779')] bg-[-335px_0px] bg-no-repeat" />}
    </div>
  )
}
