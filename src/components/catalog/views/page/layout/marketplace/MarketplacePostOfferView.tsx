...
import { Button, IlluminaCard, IlluminaCardContent, IlluminaCardHeader, LayoutFurniImageView } from "../../../../../../common"
...
export const MarketplacePostOfferView: FC<{}> = props => {
  ...
  return (
    <IlluminaCard uniqueKey="marketplace-post-offer" className="illumina-marketplace-post-offer w-[300px]">
      <IlluminaCardHeader headerText={LocalizeText("inventory.marketplace.make_offer.title")} onCloseClick={event => setItem(null)} />
      <IlluminaCardContent>
