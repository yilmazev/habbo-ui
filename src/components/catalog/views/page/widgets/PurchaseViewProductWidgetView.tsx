...
import { LayoutAvatarImage, LayoutFurniImageView, LayoutGridItem } from "../../../../../common"
...
export const PurchaseViewProductWidgetView: FC<PurchaseViewProductWidgetViewProps> = props => {
  ...
  if (currentOffer.product.productType === ProductTypeEnum.ROBOT) {
    return (
      <LayoutAvatarImage figure={currentOffer.product.extraParam} direction={3} />
    )
  }
  ...
  if (isPet) {
    return <i className="h-[75px] w-[66px] bg-[url('/client-assets/images/spritesheet.png?v=2451779')] bg-[-142px_-212px]" />
  }
