...
export const CatalogPurchaseWidgetView: FC<CatalogPurchaseWidgetViewProps> = props => {
  ...
  const isPurchasePopup: boolean = GetConfiguration("illumina.purchase.popup")
  ...
  return (
    <div className="flex gap-2.5">
      ...
      {isLimitedSoldOut
        ? <div className="relative h-[30px] w-[360px] bg-[url('/client-assets/images/spritesheet.png?v=2451779')] bg-[-102px_-181px]">
