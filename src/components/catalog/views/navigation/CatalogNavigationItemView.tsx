  ...
  return (
    <>
      <div className={getItemClasses()} onClick={(event) => activateNode(node)}>
        ...
        {node.isBranch && (
          <>
            {node.isOpen && <i className="h-[5px] w-[9px] bg-[url('/client-assets/images/spritesheet.png?v=2451779')] bg-[-277px_-32px]" />}
            {!node.isOpen && <i className="h-[9px] w-[5px] bg-[url('/client-assets/images/spritesheet.png?v=2451779')] bg-[-270px_-32px]" />}
          </>
        )}
      </div>
