...
export const CatalogView: FC<{}> = props => {
  ...
  return (
    <>
      {isVisible &&
        <IlluminaCard uniqueKey="catalog" windowPosition={DraggableWindowPosition.TOP_LEFT} className="illumina-catalog h-[560px] w-[620px]">
          <IlluminaCardHeader headerText={LocalizeText("catalog.title")} onCloseClick={event => setIsVisible(false)} />
          <IlluminaCardContent overflow="hidden" className="h-full">
