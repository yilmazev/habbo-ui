            ...
            <div>
              ...
              <div className="ml-1.5 flex items-center">
                ...
                <div className="relative h-[50px] w-10">
                  <LayoutAvatarImage figure={userFigure} direction={visualizationSettings.entryPointDir} className="absolute -left-5 top-[-30px] !h-[100px] !w-20 scale-50 overflow-hidden !bg-[center_-21px]" />
                </div>
