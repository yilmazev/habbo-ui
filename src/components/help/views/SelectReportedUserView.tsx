...
export const SelectReportedUserView: FC<SelectReportedUserViewProps> = props => {
  ...
  return (
    <IlluminaCard uniqueKey="help-select-reported-user" className="illumina-help-select-reported-user h-[490px] w-[290px]">
      <IlluminaCardHeader headerText={LocalizeText("help.bully.title")} onCloseClick={onClose} />
