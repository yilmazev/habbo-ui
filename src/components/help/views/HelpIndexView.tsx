...
export const HelpIndexView: FC<HelpIndexViewProps> = props => {
  ...
  return (
    <IlluminaBigCard uniqueKey="help-center" className="illumina-help-center w-[420px]" onCloseClick={onClose}>
      <IlluminaBigCardHeader headerText={LocalizeText("help.main.frame.title")} />
      <IlluminaBigCardContent className="text-[#010101]">
