...
export const NameChangeView: FC<{}> = props => {
  ...
  return (
    <IlluminaCard uniqueKey="name-change" className="illumina-name-change h-[225px] w-[315px]">
      <IlluminaCardHeader headerText={LocalizeText(titleKey)} onCloseClick={() => onAction("close")} />
