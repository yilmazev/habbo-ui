            ...
            {TABS.map((name, index) => {
              return (
                <NitroCardTabsItemView key={index} isActive={(currentTab === name)} onClick={event => setCurrentTab(name)} count={getCount(UNSEEN_CATEGORIES[index])}>
                  {name === "furnis" && <i className="h-[18px] w-[15px] bg-[url('/client-assets/images/spritesheet.png?v=2451779')] bg-[-103px_0px]" />}
                  {name === "pets" && <i className="h-[15px] w-[17px] bg-[url('/client-assets/images/spritesheet.png?v=2451779')] bg-[-119px_0px]" />}
                  {name === "badges" && <i className="h-4 w-[17px] bg-[url('/client-assets/images/spritesheet.png?v=2451779')] bg-[-137px_0px]" />}
                  {name === "bots" && <i className="size-[18px] bg-[url('/client-assets/images/spritesheet.png?v=2451779')] bg-[-155px_0px]" />}
