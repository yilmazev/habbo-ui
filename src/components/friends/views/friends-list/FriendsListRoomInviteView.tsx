...
export const FriendsRoomInviteView: FC<FriendsRoomInviteViewProps> = props => {
  ...
  return (
    <IlluminaCard uniqueKey="friends-room-invite" className="illumina-friends-room-invite">
      <IlluminaCardHeader headerText={LocalizeText("friendlist.invite.title")} onCloseClick={onCloseClick} />
