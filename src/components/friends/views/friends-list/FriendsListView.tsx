...
export const FriendsListView: FC<{}> = props => {
  ...
  return (
    <>
      <IlluminaCard uniqueKey="friends" className="illumina-friends h-[373px] w-[287px]">
        <IlluminaCardHeader headerText={LocalizeText("friendlist.friends")} onCloseClick={event => setIsVisible(false)} />
          ...
          <div className="h-full">
            ...
            <div className="illumina-previewer mt-1 flex items-center justify-between px-1 py-1.5">
              <Button className="!px-1" onClick={() => setShowRoomInvite(true)} disabled={!(selectedFriendsIds && selectedFriendsIds.length > 0)}>
                <i className="block h-4 w-[17px] bg-[url('/client-assets/images/spritesheet.png?v=2451779')] bg-[-426px_-84px]" />
              </Button>
