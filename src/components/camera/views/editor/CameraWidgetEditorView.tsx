...
import { Button, IlluminaBigCard, IlluminaBigCardContent, IlluminaBigCardHeader, LayoutImage, NitroCardTabsItemView, NitroCardTabsView } from "../../../../common"
...
export const CameraWidgetEditorView: FC<CameraWidgetEditorViewProps> = props => {
  ...
  return (
    <IlluminaBigCard uniqueKey="camera" className="illumina-camera w-[680px]">
      <IlluminaBigCardHeader headerText={LocalizeText("camera.editor.title")} />
          ...
          <div className="illumina-card-item shrink-0 p-1.5">
            ...
            <div className="mt-1.5 flex gap-2">
              <Button className="gap-1.5" onClick={event => processAction("download")}>
                <i className="h-[15px] w-3.5 bg-[url('/client-assets/images/spritesheet.png?v=2451779')] bg-[-410px_-126px]" />
                <p>{LocalizeText("postit.save")}</p>
              </Button>
              <Button className="gap-1.5" onClick={event => processAction("zoom")}>
                <i className="size-4 bg-[url('/client-assets/images/spritesheet.png?v=2451779')] bg-[-425px_-126px]" />
